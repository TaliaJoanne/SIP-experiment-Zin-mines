...
The frequency analysis detected $`r sum(contamdf_prev$contaminant)`$ sequences as contaminants.
In total $`r sum(contamdf_freq$contaminant) + sum(contamdf_prev$contaminant)`$ were detected as contaminants and will be removed.

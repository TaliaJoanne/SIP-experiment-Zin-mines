...
<img src="Venn_active.png" width="6000" /> \#Make a consolidated
metadata table create a metadata table where all fractions are
consolidated to fit the subsetted ASV table
...
Heord_unifracre we will examine the active community using weighed
Unifrac
...
|:----------|----:|----------:|----------:|--------:|--------:|
| Treatment |   1 | 0.2826436 | 0.1502988 | 1.23819 |    0.21 |
...
![](07_Active_community_analysis_files/figure-gfm/ordination%20active-1.png)<!-- -->

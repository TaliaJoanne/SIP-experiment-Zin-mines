...
mock_ref_seqs <- "mock/ZymoBIOMICS.STD.refseq.v2.ssrRNA_16S_515F-806R.fasta"
...
seqtab_clean <- seqtab_merged[, nchar(colnames(seqtab_merged)) %in% seq(amp_size - 30, amp_size + 30)]
